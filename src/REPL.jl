module REPL
    ...
    ReadlineREPL(t::TextTerminal) =  ReadlineREPL(t,julia_green,Base.text_colors[:normal],Base.answer_color(),Base.text_colors[:red],Base.text_colors[:yellow],false,false,0)
